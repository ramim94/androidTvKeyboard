...
class TvKeyboardView : RelativeLayout ,KbInterface{
    ...
    init {
            ...
            kbView.addItemDecoration(SpaceItemDecor())
        }

    fun addOnSearchButtonPressedListener(onSearchButtonPressedListener: OnSearchButtonPressedListener){
        this.onSearchButtonPressedListener = onSearchButtonPressedListener
    }

    fun getSearchInputView(): EditText {
        return kbInput
    }

    fun getSearchKeyboardView() : RecyclerView {
        return kbView
    }
    ...
    fun addOnItemFocusChangedListener(onItemFocusChanged: OnItemFocusChanged){
